This code represents my solution for markup files parsing, however, the code passes sample test cases but fails more advanced or edge cases => it can be optimized.
